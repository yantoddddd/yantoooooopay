// In-memory storage (akan hilang kalau server restart, tapi cukup untuk demo)
...
export default async function handler(req, res) {
    ...
    if (data.event === 'payment.received') {
        ...
        const customId = idMapping.get(qrisId) || qrisId.substring(0, 8);
        
        // 🔥 PESAN TELEGRAM PAKAI ID CUSTOM
